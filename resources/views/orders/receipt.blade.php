...
<body>
    ...
    @if($item->item_note)<div class="small">>> {{ $item->item_note }}</div>@endif
    <div class="row">
        <span>
    ...
    <div style="margin-top:15px;" class="no-print center">
        <button onclick="window.print()" style="padding:8px 20px; background:#0369a1; color:white; border:none; border-radius:8px; cursor:pointer; font-size:13px;">
            🖨️ Cetak Nota
        </button>
        <button onclick="window.close()" style="padding:8px 20px; background:#e5e7eb; color:#374151; border:none; border-radius:8px; cursor:pointer; font-size:13px; margin-left:8px;">
            ✕ Tutup
        </button>
    </div>
</body>
